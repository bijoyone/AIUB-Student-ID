<div id="left">
    ...
    <div class="subnav">
        ...
        <ul class="subnav-menu">
            <li class='dropdown'>
                <a href="#" data-toggle="dropdown">Personal Information</a>
                <ul class="dropdown-menu">
					<li>
                        <a href="usersearch.php">User Search</a>
                    </li>
                    <li>
                        <a href="personallist.php">Personal Info List</a>
                    </li>
                    <li>
                        <a href="personalinfoadd.php">Personal Info Add</a>
                    </li>
                   <!-- <li>
                    ...
                    -->
                    <li>
                        <a href="addresslist.php">Address Info List</a>
                    </li>
                    <li>
                        <a href="addressinfoadd.php">Address Info Add</a>
                    </li>
                </ul>
            </li>
